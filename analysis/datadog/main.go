...
import (
	...
	"google3/third_party/cloud_deploy_samples/analysis/util/alertwindow"
	"google3/third_party/cloud_deploy_samples/analysis/util/gcs"
)
...
func do() error {
	...
	atw, err := alertwindow.TimeWindow(ctx)
	if err != nil {
	...
	if err != nil {
		...
		analysisResult = &gcs.AnalysisMetadata{
	...
	if err := gcs.UploadResult(ctx, analysisResult, gcsClient); err != nil {
