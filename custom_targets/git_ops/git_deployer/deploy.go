...
import (
	...
	provider "google3/third_party/cloud_deploy_samples/custom_targets/git_ops/git_deployer/providers/providers"
	...
	secretmanagerpb "google3/third_party/golang/genproto/googleapis/cloud/secretmanager/v1/v1_alias"
)
