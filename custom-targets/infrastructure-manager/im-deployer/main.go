...
const (
	// The name of the Infrastructure Manager deployer sample, this is passed back to
	// Cloud Deploy as metadata in the render and deploy results.
	imDeployerSampleName = "clouddeploy-infrastructure-manager-sample"
)
